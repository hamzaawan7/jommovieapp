                                                    ...
                                                    <table align="center">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="color:#005f84;font-size:22px;font-weight:bold;text-align:center;font-family:arial">
                                                                                    ...
                                                                                    <img border="0" align="center" src="http://localhost/ovoo11/uploads/system_logo/logo.png" style="margin-top: 0px; margin-bottom: 0px; padding: 0px 10px 10px 0px; height: 50px;" data-mce-style="margin-top: 0px; margin-bottom: 0px; padding: 0px 10px 0px 0px; height: 150px;">
                                                       ...
                                                       <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:center;">
                                                            ...
                                                            <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                                <img border="0" class="content-image  " align="left" src="'.$video->image_link.'" style="display: inline-block; margin: 0px; padding: 0px 20px 10px 0px; width: 250px;">
                                                                ...
                                                                <p><span style="font-weight:bold;font-size:16px">Actor: </span> '.$video->stars.'</p>
                                                                <p><span style="font-weight:bold;font-size:16px">Director: </span> '.$video->director.'</p>                                                                
                                                            ...
                                                            <tr>
                                                                <td style="font-size:16px;line-height:27px;text-align:center;max-width:650px">
                                                                    <a href="https://ovoo.spagreen.net" style="text-decoration:none;color:#69696c" target="_blank">
                                                                        ...
                                                                        JomMovie.com- FREE Online Movie & Video Streaming
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
