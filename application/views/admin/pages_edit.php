    ...
    <div class="col-sm-12">
      ...
      <div class="form-group">
        ...
        <div class="animated-checkbox checkbox-inline">
          <label>
            <input type="checkbox" name='primary_menu' value="1" required <?php if($page['primary_menu']){ echo 'checked';} ?>><span class="label-text"><?php echo tr_wd('primary_menu'); ?> </span>
          </label>
        </div>
        <div class="animated-checkbox checkbox-inline">
          <label>
            <input type="checkbox" name='footer_menu' value="1" required <?php if($page['footer_menu']){ echo 'checked';} ?>><span class="label-text"><?php echo tr_wd('footer_menu'); ?> </span>
          </label>
        </div>
        </div>
      </div>          
