...
<head>
    ...
    <title><?php echo tr_wd($page_title) .'-'.$system_short_name;?></title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div>
                    <h1><?php echo tr_wd($page_title); ?></h1>
                </div>
            </div>
            <?php  include $page_name.'.php';?>
        </div>
    </div>
    <footer class="footer text-right"> <?php echo date("Y"); ?> © <a href="http://www.jommovie.com"> JomMovie.com &amp; Movie &amp; Video Streaming CMS</a> |
  Developed by: <a href="http://www.cryptohack.tech"> CryptoHacks Army</a> </footer>
        ...
        <div class="modal-content p-0 b-0">
          <div class="panel panel-color panel-primary">
            ...
            <div class="modal-body">
              <div id="modal-loader" style="display: none; text-align: center;"> <img src="<?php echo base_url(); ?>assets/images/preloader.gif" /><img src="<?php echo base_url(); ?>assets/images/preloader.gif" /> </div>
...
<script>
    $(document).ready(function() {
        ...
        if (success_message != '') {
            Command: toastr["success"](success_message, "Success")
            toastr.options = {
                "closeButton": false,
                "debug": false,
                "newestOnTop": false,
        ...
        if (error_message != '') {
            Command: toastr["warning"](success_message, "Opps")
            toastr.options = {
                "closeButton": false,
                "debug": false,
                "newestOnTop": false,
