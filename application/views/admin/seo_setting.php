          ...
          <div class="panel panel-border panel-primary">
            ...
            <div class="panel-body"> 
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="facebook_comment_appid" class="form-control" value="<?php echo $this->db->get_where('config' , array('title' =>'facebook_comment_appid'))->row()->value;?>" required>
                  </div>
              </div>

              <div class="form-group">
                  <label class="control-label col-md-3">Enable Facebook Comment Box</label>
                  <div class="col-sm-8">
                      <select class="form-control m-bot15" name="show_facebook_comment_box">
                      <option value="1" <?php if($this->db->get_where('config' , array('title' =>'show_facebook_comment_box'))->row()->value=='1'){echo 'selected';}?>><?php echo tr_wd('enable'); ?></option>
                      <option value="0" <?php if($this->db->get_where('config' , array('title' =>'show_facebook_comment_box'))->row()->value=='0'){echo 'selected';}?>><?php echo tr_wd('disable'); ?></option>
                      </select>
                  </div>
              </div>

              <div class="form-group">
                  <label class="control-label col-md-3">Enable Comment Box</label>
                  <div class="col-sm-8">
                      <select class="form-control m-bot15" name="show_comment_box">
                      <option value="1" <?php if($this->db->get_where('config' , array('title' =>'show_comment_box'))->row()->value=='1'){echo 'selected';}?>><?php echo tr_wd('enable'); ?></option>
                      <option value="0" <?php if($this->db->get_where('config' , array('title' =>'show_comment_box'))->row()->value=='0'){echo 'selected';}?>><?php echo tr_wd('disable'); ?></option>
                      </select>
                  </div>
              </div>
