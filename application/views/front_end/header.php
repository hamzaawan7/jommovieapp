    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-5 col-xs-6 border-right">
                <div class="logo">
                    <a href="<?php echo base_url(); ?>"> <img class="img-responsive" src="<?php echo base_url(); ?>uploads/system_logo/logo.png" alt="Logo"> </a>
                </div>
            </div>
            ...
            <div class="col-md-2 col-sm-4 border-left sm-border-top">
                ...
                <li><a href="<?php echo base_url('user/profile'); ?>"><i class="fi ion-ios-person-outline m-r-10"></i>Profile</a></li>
                <li><a href="<?php echo base_url('user/update_profile'); ?>"><i class="fi ion-edit m-r-10"></i>Update Profile</a></li>
                <li><a href="<?php echo base_url('user/change_password'); ?>"><i class="fi ion-key m-r-10"></i>Change Password</a></li>
